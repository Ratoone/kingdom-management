...
class Defeated extends Condition {
    constructor() {
        super({
            name: "Defeated",
            description: "When an army has zero Hit Points, it becomes defeated. A defeated army cannot take war actions. " +
                ...
                "A defeated army can be Disbanded normally. It can't be used for any other Army activity as long as it remains " +
                "defeated. If a defeated army takes damage, it must succeed at a DC 16 flat check or be destroyed"
        });
    }
}
